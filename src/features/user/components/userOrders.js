...
<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="border-t bg-white mt-10 border-gray-200 px-4 py-6 sm:px-6">
        <h1 className="text-4xl my-2 font-bold tracking-tight text-gray-900 ">Order Number is:{order.id}</h1>
        <h3 className="text-4xl my-2 font-bold tracking-tight text-gray-900 ">Order Status : {order.status}</h3>
